...
## جریان جدید مدیریت فایل اکسل در ربات

- با زدن `📊 آنالیز اکسل` اگر فایل نداشته باشید، ربات فایل اکسل می‌خواهد.
- پس از دریافت فایل، همه شیت‌ها تحلیل می‌شوند و تعداد سطر/ستون + هدرها نمایش داده می‌شود.
